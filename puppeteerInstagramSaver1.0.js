...
(async () => {
    console.log('puppeteer Instagram Saver1.0');
    console.log('Author: Nakateru(2021.10.03)');
    ...
    function parseJson(content){
        ...
        // console.log(str.graphql.shortcode_media.is_video);
        //video
        if (str.graphql.shortcode_media.is_video) {
        ...
        //only 1 image
                ...
                return str.graphql.shortcode_media.edge_sidecar_to_children.edges.map(x => x.node.display_url);
            }
        }
    }
